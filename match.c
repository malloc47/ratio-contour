...
#ifdef CC_PROTOTYPE_ANSI
extern int write_match (graph *G, int *elen, int *elen2, int *esolid, int *elabel_penul, char* fname) 
#else
extern int write_match (G, elen, elen2, esolid, elabel_penul, fname) 
graph *G;
int *elen, *elen2, *elabel_penul, *esolid;
char *fname;
#endif
{
    int i, c, len = 0, len2 = 0, solid = 0;
    edge *e;
    FILE* fp;
